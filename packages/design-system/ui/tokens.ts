...
export const CONTROL_VARIANTS: Record<ControlVariant, string> = {
  primary:
    'bg-eo-blue-solid text-eo-on-color shadow-eo-edge-blue enabled:hover:bg-eo-blue-solid-hover',
  ...
  outline:
    'border-2 border-eo-strong bg-eo-card text-eo-strong shadow-eo-edge-ink enabled:hover:bg-eo-sunken',
