  ...
  >
    ...
    <span
      className={cx(
        ...
        big ? 'text-[56px] font-extrabold' : 'text-eo-score',
        className,
      )}
    >
      {score}
...
export const ScoreBoard = ({
  ...
  >
    <Flex align="center" gap="20px">
      <Side
        className="text-eo-red-ink"
        label={redName}
        score={redScore}
        big={size === 'lg'}
      />
      <span className="font-eo-display text-eo-label tracking-eo-caps text-eo-faint uppercase">
        vs
      </span>
      <Side
        className="text-eo-blue-ink"
        label={blueName}
        score={blueScore}
        big={size === 'lg'}
      />
        ...
        {Array.from({ length: rounds }, (_, round) => (
          <span
            ...
            className={cx(
              ...
              PIPS[roundResults[round]] ?? 'bg-eo-hairline',
            )}
          />
        ))}
      </Flex>
